...
do
    ...
    if [ $choice -eq 1 ]; then
        curl https://raw.githubusercontent.com/firebadnofire/pzsh/main/apt-fast.sh | bash; curl -o ~/aptf https://raw.githubusercontent.com/firebadnofire/pzsh/main/aptf; sudo mv ~/aptf /etc/apt-fast.conf; sudo apt-fast install -y zsh curl git fzy
    elif [ $choice -eq 2 ]; then
        curl https://raw.githubusercontent.com/firebadnofire/pzsh/main/argon1.sh | bash
...
rm ~/.zshrc
curl -o .zshrc https://raw.githubusercontent.com/firebadnofire/pzsh/main/zshrc
